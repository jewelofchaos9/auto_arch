...
_G.packer_plugins = {
  ...
  ["heirline.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/heirline.nvim",
    url = "https://github.com/rebelot/heirline.nvim"
  },
  ["langmapper.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/langmapper.nvim",
  ...
  ["quick-scope"] = {
    ...
    url = "https://github.com/ublevable/quick-scope"
  },
  ["telescope.nvim"] = {
    loaded = true,
